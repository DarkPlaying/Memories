...
export default function RevealPage() {
      ...
      case 1:
        return (
          <div className="w-full flex flex-col items-center justify-center gap-4">
            ...
            <AudioPlayer src="/love.mp3" cover="/Ourstory26 (1920 x 1080 px).png" title="Our story" />
          </div>
        );
      case 2:
        return (
      ...
      case 4:
        return (
          <div className="w-full h-full flex flex-col items-center justify-center p-2 bg-neutral-900/10">
            ...
            <ImageSwiper
              images="/3d images/keychain.png, /3d images/her.jpeg, /3d images/me.png, /3d images/pair.png, /3d images/toy.png"
            />
          </div>
        );
      default:
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden bg-black select-none">
      ...
      <img
        src="/Ourstory26 (1920 x 1080 px).png"
