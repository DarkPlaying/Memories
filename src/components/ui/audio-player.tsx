              ...
              <div className="flex items-center gap-2 w-fit bg-[#11111198] rounded-[16px] p-2">
                ...
                >
                  <Button
                    ...
                    className={cn(
                      "text-white hover:bg-[#111111d1] hover:text-white h-8 w-8 rounded-full cursor-pointer",
                ...
                >
                  <Button
                    ...
                    className="text-white hover:bg-[#111111d1] hover:text-white h-8 w-8 rounded-full cursor-pointer"
                  >
